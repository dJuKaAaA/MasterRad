...
public class PaymentTCCServiceTest {
    ...
    public void testTCCTry_Success() {
        ...
        PaymentRequestDto paymentRequestDto = new PaymentRequestDto(BigDecimal.valueOf(100), UUID.randomUUID(), 10, userId, UUID.randomUUID());
    ...
    public void testTCCTry_FailMissingDtoFields(BigDecimal price, UUID productId, Integer productQuantity, UUID userId, String messages) {
        PaymentRequestDto paymentRequestDto = new PaymentRequestDto(price, productId, productQuantity, userId, UUID.randomUUID());
    ...
    public void testTCCTry_FailQuantityLessThanOne() {
        UUID userId = getUserId();
        PaymentRequestDto paymentRequestDto = new PaymentRequestDto(BigDecimal.valueOf(100), UUID.randomUUID(), 0, userId, UUID.randomUUID());
    ...
    public void testTCCTry_FailInsufficientBalance() {
        UUID userId = getUserId();
        PaymentRequestDto paymentRequestDto = new PaymentRequestDto(BigDecimal.valueOf(1000000), UUID.randomUUID(), 10, userId, UUID.randomUUID());
