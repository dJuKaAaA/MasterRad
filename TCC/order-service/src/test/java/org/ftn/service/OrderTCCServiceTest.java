...
public class OrderTCCServiceTest {
    ...
    public void testTCCTry_Success() {
        ...
        OrderRequestDto orderRequestDto = new OrderRequestDto(UUID.randomUUID(), 5, UUID.randomUUID(), UUID.randomUUID());
    ...
    public void testTCCTry_FailMissingDtoFields(UUID productId, Integer quantity, UUID userId, String messages) {
        OrderRequestDto orderRequestDto = new OrderRequestDto(productId, quantity, userId, UUID.randomUUID());
    ...
    public void testTCCTry_FailInvalidQuantity() {
        Integer quantity = 0;
        OrderRequestDto orderRequestDto = new OrderRequestDto(UUID.randomUUID(), quantity, UUID.randomUUID(), UUID.randomUUID());
        Set<ConstraintViolation<OrderRequestDto>> violations = validator.validate(orderRequestDto);
