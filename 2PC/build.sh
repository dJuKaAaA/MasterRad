cd ./coordinator
./mvnw clean package
docker build -f src/main/docker/Dockerfile.jvm -t quarkus/coordinator-2pc-jvm .
...
cd ../user-service
./mvnw clean package
docker build -f src/main/docker/Dockerfile.jvm -t quarkus/user-service-2pc-jvm .
